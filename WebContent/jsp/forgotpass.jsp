...
<div class="signup-form">
    <form action="register" method="post">
		<h2>Quên mật khẩu</h2>
		<p class="hint-text">Cung cấp mật khẩu mới</p>
		...
		<div class="form-group">
            <input type="user" class="form-control" name="user" placeholder="Tài khoản " required="required">
        </div>      
        <div class="form-group">
			<label class="checkbox-inline"><input type="checkbox" required="required"> Nhận code xác nhận <a href="#"></a> &amp; <a href="#"></a></label>
		</div>
